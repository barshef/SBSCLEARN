...
using SBSCLEARN.Infrastructure.Mapping;
using SBSCLEARN.Persistence;
using SBSCLEARN.Service.Contract;
using SBSCLEARN.Service.Implementation;
using System;
using System.IO;
using System.Reflection;

namespace SBSCLEARN.Infrastructure.Extension
{
            ...
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    ...
                    new Microsoft.OpenApi.Models.OpenApiInfo()
                    {
                        Title = "Course API",
                        Version = "1",
                        Description = "Through this API you can access course details",
                        Contact = new Microsoft.OpenApi.Models.OpenApiContact()
                        {
                            Email = "engr.isholaicma@gmail.com",
                            Name = "Ishola Adebayo",
